...
This an ABM model of sheep(agents) and wolves within an environment. 
Wolves and sheep comminicate in the model.
Wolves are programmed to eat the sheep
This makes use of webscarpping and creates a GUI where the output is produced
"""
# Import libaries
import csv
...
def run():
    '''
    Function to run animation and draw canvas
...
#User input of number of wolves and sheep
s = (simpledialog.askstring(title="Number of sheep",
                                  prompt="How many sheep?:"))
w = (simpledialog.askstring(title="Number of Wolves",
                                  prompt="How many hungry wolves?:"))
try:
    num_agents = int(s)
    num_wolves = int(w)
...
#Connects to agentframe work for agents
...
#connects to agent frame work for wolves
